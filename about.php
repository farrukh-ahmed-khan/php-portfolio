      ...
      <div class="reviews-wrapper">
         <div class="container-fluid">
            ...
            <div class="softnox-btn">
               <a href="work.php">
                  <button>VIEW PROJECT REFERENCES</button>
               </a>
            </div>
         </div>
      </div>
         ...
         <div class="row">
            <div class="col-lg-5 col-md-12 mb-4">
               ...
               <div class="get-in-touch-para">
                  <p>
                     Available for Full Stack and React Native projects. Reach out for web applications, APIs, dashboards, and mobile app development.
                  </p>
               </div>
